                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3"><img src="{{ asset('storage/siswa/'.$siswa->bukti) }}" class="rounded-md" style="width: 100px;" alt=""></td>
                            <td class="px-4 py-3">
                            ...
                            <td>
                            <a href="{{route('guru.edit', $siswa->id)}}"  class="flex items-center justify-center
                                 text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 mr-5
                                  dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"><button type="button">EDIT</button>
